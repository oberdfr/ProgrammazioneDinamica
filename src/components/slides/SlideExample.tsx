                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 flex-1">
                    ...
                    >
                        <div className="text-gray-600 dark:text-gray-300 mb-16">
                            <span className='text-2xl'>costo gap (δ): 1 | costo mismatch (α): 1 | costo match: 0.</span>
                        </div>
                        ...
                        {showTraceback && (
                            <div className="mt-40 text-center text-gray-600 dark:text-gray-300 text-3xl">
                                Valore ottimo: <span className="font-bold">2</span> (elemento M[7,7] in basso a destra)
                            </div>
                        )}
                    </motion.div>
                    ...
                    >
                        <div className="bg-white dark:bg-slate-700 p-4 rounded-lg shadow flex-1">
                            ...
                            <ol className="list-decimal pl-6 space-y-2 text-gray-700 dark:text-gray-200">
                                <li> <span className="text-xl"> Parti da M[m, n] (l'elemento in basso a destra).</span></li>
                                <li> <span className="text-xl"> Risali seguendo le scelte che hanno portato al valore minimo in ogni cella: </span>
                                    <ul className="list-disc pl-6 mt-2 space-y-1">
                                        <li>
                                            <span className="font-semibold text-xl">Diagonale:</span> x<sub>i</sub>
                                            <span className="text-xl">
                                                allineato con y<sub>j</sub>
                                            </span>
                                        </li>
                                        <li>
                                            <span className="font-semibold text-xl">Su:</span> x<sub>i</sub>
                                            <span className="text-xl">
                                                allineato con gap
                                            </span>
                                        </li>
                                        <li>
                                            <span className="font-semibold text-xl">Sinistra:</span> y<sub>j</sub>
                                            <span className="text-xl">
                                                allineato con gap
                                            </span>
                                        </li>
                                ...
                                <li> <span className="text-xl"> Questo percorso inverso ricostruisce l'allineamento ottimo. </span> </li>
                            </ol>
                        </div>
                            ...
                            {showTraceback && (
                                ...
                                >
                                    ...
                                    <p className="mt-3 text-center text-gray-600 dark:text-gray-300">
                                        Costo: 2 (Un gap per la lettera mancante e un mismatch)
                                    </p>
                                </motion.div>
                            )}
                        </div>
