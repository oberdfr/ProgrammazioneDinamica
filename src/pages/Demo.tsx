...
import { calculate } from '../algorithms/js/algorithm';
...
const Demo = () => {
  ...
  const handleRunCode = async () => {
    ...
    try {
      ...
      // Run calculation
      const result = calculate(sequence1, sequence2, gapPenalty, mismatchPenalty);
          ...
          <div className="space-y-4">
            ...
            <div className="pt-2">
              <button
                ...
                disabled={isRunning}
                className={`w-full flex justify-center items-center py-2 px-4 rounded-md transition-colors duration-200 text-white ${
                  isRunning
